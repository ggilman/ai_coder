...
execute_tool() {
    ...
    local cmd_exec="docker exec -it -e TERM=xterm-256color -e COLORTERM=truecolor -e GOOGLE_GEMINI_BASE_URL=http://127.0.0.1:4000 $container gemini --max_iterations 20"
