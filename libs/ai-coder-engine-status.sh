...
# ENGINE_NAME, HEALTH_TIMEOUT, SLOTS_TIMEOUT, _ENGINE_TMP, and _SLOTS_TMP
# before calling these — kept as caller-provided globals (not parameters) to
# match how both dashboards already wire the temp-file paths into their trap
# cleanup.
#
