#!/usr/bin/env python3
# ==============================================================================
# OPENCODE-PTY.PY | PTY Wrapper to Suppress Ctrl-C in OpenCode
# Mounted read-only into the OpenCode workbench container (see start_workbench
# in agents/ai-coder-opencode.sh) and invoked directly in place of `opencode`
# by execute_tool. OpenCode does not handle SIGINT/Ctrl-C well from inside a
# `docker exec` TTY, so this spawns it in its own PTY and strips Ctrl-C bytes
# from the input stream instead of letting the signal reach the process.
# ==============================================================================
